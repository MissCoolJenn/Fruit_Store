    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_pk', models.ForeignKey(on_delete=models.SET(Store.models.return_name), to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('product_pk', models.ForeignKey(on_delete=models.SET(Store.models.return_name), to='Store.product')),
                ('user_pk', models.ForeignKey(on_delete=models.SET(Store.models.return_name), to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
